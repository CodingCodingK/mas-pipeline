...
class AgentRun(Base):
    ...
    tool_use_count: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
...
class ChatSession(Base):
    ...
    # Allowed values: "chat" (1:1 assistant), "autonomous" (coordinator),
    # "bus_chat" (third-party group chat clawbot).
